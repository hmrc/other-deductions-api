...
@Singleton
class CreateAndAmendOtherDeductionsConnector @Inject() (val http: HttpClientV2, val appConfig: SharedAppConfig) extends BaseDownstreamConnector {

  def createAndAmend(request: CreateAndAmendOtherDeductionsRequestData)(implicit
      hc: HeaderCarrier,
      ec: ExecutionContext,
