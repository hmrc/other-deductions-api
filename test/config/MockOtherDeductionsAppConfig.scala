...
import config.{OtherDeductionsAppConfig, ConfidenceLevelConfig}
import org.scalamock.handlers.{CallHandler, CallHandler0}
import org.scalamock.scalatest.MockFactory
import play.api.Configuration
import routing.Version

trait MockOtherDeductionsAppConfig extends MockFactory {

  implicit val mockAppConfig: OtherDeductionsAppConfig = mock[OtherDeductionsAppConfig]
